$(document).ready(function() {
	...
	var randomNumber = function() {
			return Math.floor(Math.random() * (750 - 376 + 1)) + 376;
	...
	circles.forEach(function(circle) {
		circle.attr({
			transform: 't0,'+randomNumber()*randomBoolean()
		});
	});
	...
	var animateCircles = function() {
		circles.forEach(function(circle) {
			circle.stop().animate({transform: 't0,0'}, 2000, mina.backout, animateLines);
		});
	}
